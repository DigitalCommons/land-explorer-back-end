...
import { assert, createSandbox, type SinonSpy } from "sinon";
...
describe("Send reset password email", () => {
  ...
  const testResetLink =
    "https://app.landexplorer.coop/auth?email=douglas.quaid%40yahoomail.com&reset_token=RQMG8R2WJHDEYTAIU1PA4SU7CRXC9WTWTEPDID5MB9MNKNBW2VV87UM2HXLUJZZK";
  const expiryHours = 24;
  let fakeSend: SinonSpy;

  beforeEach(() => {
    fakeSend = sandbox.stub(MailService.prototype, "send").resolves();
  });
